              ...
              <div className="commentItem">
                <div className="commentUser">
                  ...
                  <div className="commentUser__detail">
                    ...
                    <div className="commentUser__score"> <Star value={comment.score}/> <span className="commentUser__value">{comment.score}分</span></div>
                  </div>
                </div>
                <CollapsibleText height={112}>{comment.content}</CollapsibleText>
